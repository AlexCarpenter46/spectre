...
double minimum_ahc_excision_radius(
  ...
  // These are assumed to be the x-positions of the excisions A/B at the start
  // of the inspiral
  ...
  if (excision_radius > ahc_average_radius + eps) {
  ...
  } else if (excision_radius > ahc_average_radius - 3 * eps) {
    ERROR(
