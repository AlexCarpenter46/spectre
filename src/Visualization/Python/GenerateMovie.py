...
def generate_trace(file_destination, output, camera_angle, shift, Ah_Surfaces):
    ...
    volumeFilesxmf = XDMFReader(
        registrationName='VolumeFiles.xmf',
        FileNames=[file_destination + "VolumeFiles.xmf"])
    ...
    volumeFilesxmfDisplay = GetDisplayProperties(volumeFilesxmf,
                                                 view=renderView1)
    # get color transfer function/color map for 'Lapse'
    lapseLUT = GetColorTransferFunction('Lapse')
    lapseLUT.RGBPoints = [
        0.47452330589294434, 0.231373, 0.298039, 0.752941, 0.7356098592281342,
        0.865003, 0.865003, 0.865003, 0.996696412563324, 0.705882, 0.0156863,
        0.14902
    ]
    ...
    lapsePWF.Points = [
        0.47452330589294434, 0.0, 0.5, 0.0, 0.996696412563324, 1.0, 0.5, 0.0
    ]
    ...
    slice1Display.ScaleTransferFunction.Points = [
        0.878652036190033, 0.0, 0.5, 0.0, 0.996696412563324, 1.0, 0.5, 0.0
    ]
    ...
    absValueSpatialRicciLUT.RGBPoints = [
        1.3087053964190598e-15, 0.231373, 0.298039, 0.752941,
        0.5333755612373359, 0.865003, 0.865003, 0.865003, 1.0667511224746704,
    ...
    warpByScalar1Display.ScaleTransferFunction.Points = [
        1.3087053964190598e-15, 0.0, 0.5, 0.0, 1.0667511224746704, 1.0, 0.5,
        0.0
    ]
    # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
    ...
    absValueSpatialRicciPWF = GetOpacityTransferFunction(
        'AbsValueSpatialRicci')
    absValueSpatialRicciPWF.Points = [
        1.3087053964190598e-15, 0.0, 0.5, 0.0, 1.0667511224746704, 1.0, 0.5,
        0.0
    ]
    ...
    if (Ah_Surfaces == 0):
        # create a new 'XDMF Reader'
        ahAxmf = XDMFReader(registrationName='AhA.xmf',
                            FileNames=[file_destination + "AhA.xmf"])
        ...
        ricciScalarLUT.RGBPoints = [
            1.9988615925761155, 0.231373, 0.298039, 0.752941,
            1.999732833173388, 0.865003, 0.865003, 0.865003,
            2.0006040737706603, 0.705882, 0.0156863, 0.14902
        ]
        ...
        ricciScalarPWF.Points = [
            1.9988615925761155, 0.0, 0.5, 0.0, 2.0006040737706603, 1.0, 0.5,
            0.0
        ]
        ...
        # create a new 'XDMF Reader'
        ahBxmf = XDMFReader(registrationName='AhB.xmf',
                            FileNames=[file_destination + "AhB.xmf"])
        ...
        ahBxmfDisplay.ScaleTransferFunction.Points = [
            1.998871756148613, 0.0, 0.5, 0.0, 2.000595342018353, 1.0, 0.5, 0.0
        ]
        # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
    ...
    annotateTimeFilter1 = AnnotateTimeFilter(
        registrationName='AnnotateTimeFilter1', Input=warpByScalar1)
    # show data in view
    ...
    if (shift == 0):
        ...
        glyph1Display.ScaleTransferFunction.Points = [
            1.7175290703552726e-11, 0.0, 0.5, 0.0, 1.058470606803894, 1.0, 0.5,
            0.0
        ]
        # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
    ...
    if (camera_angle == 1):
        ...
        renderView1.CameraPosition = [
            -16.82050334149194, -1.8559824362222395, 2.6797079790683345
        ]
        renderView1.CameraFocalPoint = [
            0.0836179084847767, -1.0057516274428049, 0.22771979385109334
        ]
